...
function update(){
    ...
    document.getElementById("app-body").style.backgroundColor =
      "rgb(" + R + "," + G + "," + B + ")";
    document.getElementById("main-title").style.color =
      "rgb(" + R + "," + G + "," + B + ")";
          document.getElementById("sub-title").style.color =
            "rgb(" + R + "," + G + "," + B + ")";
          ...
          document.getElementById("blue").style.backgroundColor =
            "rgb(" + R + "," + G + "," + B + ")";
                document.getElementById("green").style.backgroundColor =
                  "rgb(" + R + "," + G + "," + B + ")";
                      document.getElementById("variability").style.backgroundColor =
                        "rgb(" + R + "," + G + "," + B + ")";
