...
//settings.js is the main settings directory
//paste code from settings-flex.js, settings-static.js or settings-upload.js
//for different iterations
//settings-upload.js allows use of JSON sim settings from previous studies
...
const simulationSettings = {
  ...
  mutationStrength: randNum(0, 0.5),
